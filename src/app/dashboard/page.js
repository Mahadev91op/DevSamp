...
export default function Dashboard() {
 ...
 const handleLogout = async () => {
  ...
  localStorage.removeItem("user"); // Client state clear
  router.push("/login");
};
      ...
      <main className="flex-1 p-6 md:p-10 md:ml-64 w-full max-w-7xl mx-auto pb-24 md:pb-10">
        <header className="mb-10">
          ...
          <p className="text-gray-400 text-sm md:text-base">
            Track progress, updates, and deliverables.
          </p>
        </header>
          ...
          {loading ? (
            ...
            <div className="p-10 border border-white/10 rounded-3xl bg-[#0a0a0a] text-center">
              ...
              <p className="text-gray-400">
                Contact admin to link your project.
              </p>
            </div>
          ) : (
            <>
              ...
              {activeTab === "overview" && (
                <>
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <StatCard
                      label="Payment"
                      value={projectData.paymentStatus}
                      icon={
                        <DollarSign
                          className={
                            ...
                            <div className="flex flex-col items-center mr-6">
                              <div
                                className={`w-10 h-10 rounded-full flex items-center justify-center border-2 z-10 transition-all ${
                                  ...
                                  projectData.progress >= (index + 1) * 20
                          ...
                          projectData.documents.map((doc, idx) => (
                            ...
                            >
                              <div className="flex items-center gap-4">
                                ...
                                <div>
                                  <h4 className="text-sm font-bold text-white mb-0.5 line-clamp-1">
                                    {doc.name}
                                  </h4>
                              ...
                              <div className="flex gap-2">
                                <a
                                  ...
                                  target="_blank"
                                  download
                                  className="p-2 bg-black hover:bg-white text-gray-400 hover:text-black rounded-lg transition-colors"
                                  title="Download"
                                >
                                  <Download size={16} />
                                </a>
                  ...
                  <div className="bg-[#0a0a0a] border border-white/10 p-8 rounded-3xl">
                    ...
                    <div className="p-4 bg-white/5 rounded-xl border border-white/5">
                      ...
                      <p className="text-xs text-gray-500">
                        Contact admin for PayPal/Wise link.
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                      {projectData.links.map((link, i) => (
                        <a
                          ...
                          target="_blank"
                          key={i}
                          className="flex flex-col p-6 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl transition-all group"
                        >
                          <div className="p-3 bg-blue-600/20 text-blue-400 w-fit rounded-xl mb-4 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                            <LinkIcon size={24} />
                          </div>
              ...
              {activeTab === "settings" && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div className="bg-[#0a0a0a] border border-white/10 p-8 rounded-3xl">
                    <h3 className="text-xl font-bold mb-6 flex items-center gap-2">
                      <Settings className="text-blue-500" size={24} /> Profile
                      Settings
                    </h3>
                    ...
                    <form
                      onSubmit={async (e) => {
                        ...
                        if (newPassword && !currentPassword) {
                          alert(
                            "Please enter current password to set a new one."
                          );
                          return;
                        }

                        setUploading(true); // Reusing loading state
                        try {
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full bg-black border border-white/10 rounded-xl px-4 py-3 text-white outline-none focus:border-blue-500 transition-all"
                            required
                          />
                        </div>
                        ...
                        <button
                          disabled={uploading}
                          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-xl transition-all shadow-lg mt-2 flex items-center justify-center gap-2"
                        >
                          {uploading ? (
                  ...
                  <div className="space-y-6">
                    <div className="bg-[#0a0a0a] border border-white/10 p-8 rounded-3xl">
                      ...
                      <p className="text-gray-400 text-sm mb-6 leading-relaxed">
                        Facing issues with your project or dashboard? Our
                        support team is available 24/7 to assist you directly.
                      </p>
                      <a
                    ...
                    <div className="bg-gradient-to-br from-blue-900/20 to-purple-900/20 border border-blue-500/20 p-8 rounded-3xl">
                      ...
                      <p className="text-blue-200 text-sm mb-4">
                        You are currently on the standard plan. Upgrade for
                        priority support and faster delivery.
                      </p>
                      <button className="text-xs font-bold text-white bg-blue-600 px-4 py-2 rounded-lg hover:bg-blue-500 transition-all">
                        View Plans
                      </button>
                    </div>
                  </div>
...
const NavItem = ({ icon: Icon, label, id, active, set }) => (
  ...
  >
    <Icon
      size={20}
      className={
        active === id ? "text-black" : "text-gray-500 group-hover:text-white"
      }
    />{" "}
    {label}{" "}
...
const StatCard = ({ label, value, icon, sub }) => (
  <div className="bg-[#0a0a0a] border border-white/10 p-6 rounded-3xl hover:border-white/20 transition-all cursor-default">
    <div className="flex justify-between items-start mb-4">
      ...
      <span className="text-xs font-bold bg-white/5 px-2 py-1 rounded text-gray-400">
        {sub}
      </span>
    </div>
