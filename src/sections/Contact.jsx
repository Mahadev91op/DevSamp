            ...
            <AnimatePresence>
                {status === "success" && (
                    <motion.div 
                        ...
                        exit={{ opacity: 0 }}
                        className="absolute inset-0 z-20 bg-black/80 backdrop-blur-md rounded-3xl flex flex-col items-center justify-center text-center p-8"
                    >
                        ...
                        <button 
                            ...
                            className="mt-6 px-6 py-2 bg-white/10 hover:bg-white/20 rounded-full text-sm"
                        >
                            Send Another
                        </button>
                    </motion.div>
